...
///   ZISK_BUMP_HEAP_POS / ZISK_BUMP_HEAP_TOP — heap region vars
...
export var ZISK_BUMP_HEAP_POS: usize = 0;
export var ZISK_BUMP_HEAP_TOP: usize = 0;

export fn openvm_init_heap() void {
    ZISK_BUMP_HEAP_POS = @intFromPtr(&_end);
    ZISK_BUMP_HEAP_TOP = GUEST_MAX_MEM;
}
